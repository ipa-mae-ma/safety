...
def worker(params, mode='mini'):
    ...
    if mode.lower() == 'mini':
        ...
        # params['reward_dim'] = len(env.possible_fruits) + 1
        env.state_shape = [104] # 100 pacman 100 ghost 4 possible fruits
        params['reward_dim'] = 5
    elif mode.lower() == 'small':
        env = FruitCollectionSmall(rendering=True, game_length=1500, state_mode='multi-head', is_ghost=True)
